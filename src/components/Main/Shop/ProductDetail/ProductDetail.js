...
export default class ProductDetail extends Component {
    ...
    render() {
        ...
        //lay cac thuoc tinh cua product truyen sang tu Home
        const { id, name, price, color, material, description, images } = this.props.product;
        return (
            <View style={wrapper}>
                        ...
                        <View style={descContainer}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 15 }}>
                                ...
                                <View style={{ flexDirection: 'row' }} >
                                    ...
                                    <View style={{ height: 15, width: 15, backgroundColor: color.toLowerCase(), borderRadius: 15, marginLeft: 10, borderWidth: 1, borderColor: color.toLowerCase() }} />
                                </View>
                            </View>
                        </View>
                    </View>
